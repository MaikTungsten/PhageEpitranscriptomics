...
knitr::opts_knit$set(root.dir = "/Users/maikschauerte/Desktop/NAR_Revision/PhageEpitranscriptomics-main/")
```
...
ec_anno <- read.delim("Differential_RNA-Seq/U00096.3_TSS_dRNA-Seq.gff", comment.char="#", stringsAsFactors=TRUE, header = FALSE)
...
```{r}
ec_061 <- read.delim("../Phage_NAD-RNA_analysis/Updated_NAD-RNA_TSS_annotation/TSS_U00096-3_R1.gff3", comment.char="#", stringsAsFactors=TRUE, header = FALSE)
...
ec_065 <- read.delim("../Phage_NAD-RNA_analysis/Updated_NAD-RNA_TSS_annotation/TSS_U00096-3_R2.gff3", comment.char="#", stringsAsFactors=TRUE, header = FALSE)
...
t4_anno <- read.delim("Differential_RNA-Seq/NC_000866.4_TSS_dRNA-Seq.gff", comment.char="#", stringsAsFactors=TRUE, header = FALSE)
...
```{r}
t4_061 <- read.delim("/Users/maikschauerte/Desktop/NAR_Revision/Phage_NAD-RNA_analysis/Updated_NAD-RNA_TSS_annotation/TSS_NC_000866-4_R1.gff3", comment.char="#", stringsAsFactors=TRUE, header = FALSE)
...
t4_065 <- read.delim("/Users/maikschauerte/Desktop/NAR_Revision/Phage_NAD-RNA_analysis/Updated_NAD-RNA_TSS_annotation/TSS_NC_000866-4_R2.gff3", comment.char="#", stringsAsFactors=TRUE, header = FALSE)
